...
public class GamePlayScreen extends JPanel implements KeyListener {
    ...
    private SpaceShipENEMY enemySpaceShip = new SpaceShipENEMY();
    ...
    public void keyPressed (KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_SPACE) userSpaceShip.gun.fire (userSpaceShip.getX(), userSpaceShip.getY(), userSpaceShip);
